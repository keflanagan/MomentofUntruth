...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--c_loss_coef", type=float, default=1., help="classification loss")
        # *** in-domain and out-of-domain
        parser.add_argument('--in_coef', default=0.1, type=float, help="relative weight of the in-domain negative loss")
        parser.add_argument('--out_coef', default=0.1, type=float, help="relative weight of the out-of-domain negative loss")
        # * Eval configs
        ...
        parser.add_argument("--pos_train_path", type=str, default=None, nargs='+')
        parser.add_argument("--neg_train_path", type=str, default=None, nargs='+')
        parser.add_argument("--neg_indomain_train_path", type=str, default=None, nargs='+')
        parser.add_argument("--eval_path", type=str, default=None,
                            help="Evaluating during training, for Dev set. If None, will only do training, ")
        parser.add_argument("--neg_eval_path", type=str, default=None,
                            help="Evaluating during training, for Dev set. If None, will only do training, ")
        ...
        parser.add_argument("--pred_save_path", type=str, default=None, nargs='+')
...
def setup_model(opt):
    ...
    if opt.resume is not None:
        ...
        model.load_state_dict(checkpoint["model"], strict=False) # edited to strict=False by Kevin

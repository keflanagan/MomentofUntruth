...
class Model(nn.Module):
    ...
    def __init__(self, transformer, position_embed, txt_position_embed, txt_dim, vid_dim,
        ...
        # LSTM for pos/neg classification
        self.lstm = nn.LSTM(input_size=1, hidden_size=50, num_layers=1, batch_first=True)
        self.class_layer = nn.Linear(50, 1)
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_cls=None, src_cls_mask=None):
        ...
        # print(print('vid size', src_vid.size()))
...
def build_model(args):
    ...
    weight_dict = {"loss_b": args.b_loss_coef,
                   ...
                   "loss_c": args.c_loss_coef,}

    if args.dset_type in ['mr', 'vlp']:
        if 'tal' not in args.pos_train_path:
            losses = ['spans', 'labels', 'saliency', 'class']
        else:

...
######## data paths
pos_train_path=data/${dset_name}/metadata/charades_pos_train.jsonl
neg_train_path=data/${dset_name}/metadata/charades_ood_neg_train.jsonl
neg_indomain_train_path=data/${dset_name}/metadata/charades_id_neg_train.jsonl
eval_path=data/${dset_name}/metadata/charades_pos_test.jsonl
neg_eval_path=data/${dset_name}/metadata/charades_id_neg_test.jsonl
pred_save_path=preds/${dset_name}/test_id_preds_most_recent_epoch.json
eval_split_name=val
...
python3 ./main/train_mr_indomain_outofdomain_neg.py \
--dset_type ${dset_type}   \
--dset_name ${dset_name} \
...
--neg_train_path ${neg_train_path} \
--neg_indomain_train_path ${neg_indomain_train_path} \
--eval_path ${eval_path} \
--neg_eval_path ${neg_eval_path} \

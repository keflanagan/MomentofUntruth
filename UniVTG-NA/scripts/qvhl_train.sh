...
# resume=./results/qvhl/model_best_qvhl.ckpt
...
######## data paths
pos_train_path=data/${dset_name}/metadata/qvhl_pos_train.jsonl
neg_train_path=data/${dset_name}/metadata/qvhl_ood_neg_train.jsonl
neg_indomain_train_path=data/${dset_name}/metadata/qvhl_id_neg_train.jsonl
eval_path=data/${dset_name}/metadata/qvhl_pos_val.jsonl
neg_eval_path=data/${dset_name}/metadata/qvhl_id_neg_val.jsonl
pred_save_path=preds/${dset_name}/val_id_preds_most_recent_epoch.json
eval_split_name=val

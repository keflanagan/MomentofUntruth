...
neg_train_path=data/${dset_name}/metadata/charades_id_neg_train.jsonl
eval_path=data/${dset_name}/metadata/charades_id_neg_test.jsonl
pred_save_path=preds/${dset_name}/preds_indomain.json
eval_split_name=val

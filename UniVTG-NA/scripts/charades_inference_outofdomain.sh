...
#resume=./results/mr-charades/charades_train-slowfast_clip-clip-2024_07_03_15/model_best.ckpt
resume=./results/mr-charades/finetuned/model_best.ckpt
...
eval_path=data/${dset_name}/metadata/charades_ood_neg_test.jsonl
pred_save_path=preds/${dset_name}/preds_outofdomain.json
eval_split_name=val
...
python negative_aware_results.py --gt_path ${eval_path} --pred_path ${pred_save_path}

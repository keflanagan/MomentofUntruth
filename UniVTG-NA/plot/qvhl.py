...
def plot_video(pred_json, gt_json, save_dir_i, fig_num=None, template=True):
    ...
    fig, axs = plt.subplots(nrows=1, ncols=fig_num, figsize=(100, 20), gridspec_kw={'wspace': 0.0, 'hspace': 0.0})
...
if __name__ == "__main__":
    ...
    video_path="dataset/qvhighlights_val_segment"
    gt_path="plot/qvhl/gt.jsonl"

    dset_path="results/mr-qvhighlights"
    checkpoint_dir="qvhl"
